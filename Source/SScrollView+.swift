...
//  Copyright © 2024 Sakule. All rights reserved.
//
...
extension UIView {
    ...
    @discardableResult
    public func addScrollView(_ scrollView: SScrollView, withSafeArea: DViewSafeArea = .none, hasStatusBarCover: Bool = false, statusBarBackgroundColor: UIColor = .white, container: SScrollViewContainer, elements: UIView...) -> UIView {
